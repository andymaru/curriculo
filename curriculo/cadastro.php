...
$perfil = "INSERT INTO perfil (nome, celular, email, github, escolaridade, curso, anoconclusao, nvidioma, idioma, resumo) 
VALUES ('$nome' , '$celular', '$email', '$github', '$escolaridade', '$curso', '$anoconclusao','$nvidioma', '$idioma', '$resumo')";
